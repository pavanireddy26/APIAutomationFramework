...
public class TestE2EFlow_01 extends BaseTest {
    ...
    //2. create tokens -> token

//3.verify thar create booking is working -GET request to booking Id
    //4. update the booking (booking ,token) - Need to get the token , booking

//5. delete the Booking - needsthe Booking - need to get the token , bookingID from above request
